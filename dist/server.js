...
const PORT = app_2.APP_CONFIG.SERVER.PORT;
const startServer = async () => {
    try {
        await prisma_1.default.$connect();
        console.log('✅ Database connected successfully');
        const app = (0, app_1.default)();
        const { initializeScheduledReports } = await Promise.resolve().then(() => __importStar(require('./modules/report/services/reportSchedulerService')));
